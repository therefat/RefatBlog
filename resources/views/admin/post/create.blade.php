        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="post" novalidate action="{{ route('admin.post.store') }}" enctype= "multipart/form-data" class=" space-y-6">
{{--                        Title--}}
                        <div>
...
{{--                        Body--}}
                        <div class="summernote-container">
                            ...
                            <textarea class="custom-content" id="summernote" name="body" :value="old('body')" required autofocus autocomplete="body"></textarea>
...
{{--                        <div class="summernote-container">--}}
{{--                            <textarea class="custom-content" id="summernote" name="editordata"></textarea>--}}
{{--                        </div>--}}
